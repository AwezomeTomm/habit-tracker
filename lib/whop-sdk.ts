...
// Only initialize the SDK if we have the required environment variables
let whopSdk: ReturnType<typeof WhopServerSdk> | null = null;
...
try {
	whopSdk = WhopServerSdk({
		...
		appId: process.env.NEXT_PUBLIC_WHOP_APP_ID ?? "habit-tracker-app",
	...
	console.warn('Whop SDK initialization failed:', error);
	whopSdk = null;
}
